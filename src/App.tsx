...
function App() {
  ...
  return (
    <div className='flex flex-col items-center p-6 text-[#121212]'>
        ...
        Array.isArray(posts) ? posts.map((post:Post)=>{
          ...
          <div key={post.id} className='w-[400px] h-[400px] flex flex-col m-6 shadow-lg'>
            ...
            <div className='p-4'>
              ...
              <a className='pt-auto text-sm text-[#f9423b] cursor-pointer'>Read more<FontAwesomeIcon className='pl-1' icon={faArrowRight} /></a>
          </div>
          </div>
